...
RegisterNetEvent('vehiclekeys:client:SetOwnersamy', function(plate)
    TriggerServerEvent('qb-vehiclekeys:server:AcquireVehicleKeysamy', plate)
end)


-- RegisterNetEvent('vehiclekeys:client:SetOwnersamy', function(vehicle)
--     local currentPlate = GetVehicleNumberPlateText(vehicle)
-- TriggerServerEvent('qb-vehiclekeys:server:AcquireVehicleKeys', currentPlate)
